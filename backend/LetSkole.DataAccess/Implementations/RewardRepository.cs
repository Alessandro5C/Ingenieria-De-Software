...
namespace LetSkole.DataAccess
{
    public class RewardRepository : IRewardRepository
    {
        ...
        public RewardRepository(LetSkoleDbContext context)
        {
        ...
        // public async Task<ICollection<Reward>> GetCollectionByUserId(string userId)
        // {
        ...
        public async Task CreateForUser(RewardUser entity)
        {
            throw new NotImplementedException();
        }

        public async Task DeleteForUser(string userId, int rewardId)
        {
            throw new NotImplementedException();
        }
        ...
        public async Task<ICollection<Reward>> GetCollectionByGameId(int gameId)
        {
            throw new NotImplementedException();
        }
    }
